              ...
              {registros
                .map((dato) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-2 border-b border-gray-300 truncate-cell" style={{ width: '20%' }}>{dato.tipo}</td>
                    <td className="px-4 py-2 border-b border-gray-300 truncate-cell" style={{ width: '30%' }}>{dato.descripcion}</td>
